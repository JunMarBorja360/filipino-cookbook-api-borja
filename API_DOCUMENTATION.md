...
## 1. Project Title
Filipino Online Cookbook (I NAMED IT)
...
The Filipino Online Cookbook (API) is a RESTful API developed using PHP, Slim Framework, and MySQL. It provides information about Filipino dishes, including the categories, origins, ingredients, and cooking instructions. The API uses Bearer Token Authentication to secure its endpoints.
...
4. Copy the project into the htdocs folder.
...
Returns all food-ingredient relationships.

POST /api/food_ingredients

Adds a food-ingredient relationship.
...
All GET and POST endpoints returned successful JSON responses after authentication.
...
Course: BS Information Technology (4th Year Section A)

School: Don Mariano Marcos Memorial State University – Mid-La Union Campus (DMMMSU-MLUC)